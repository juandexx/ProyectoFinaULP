...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2023 a las 23:38:55
...
INSERT INTO `paciente` (`idPaciente`, `nombre`, `apellido`, `dni`, `edad`, `domicilio`, `celular`, `estado`) VALUES
(1, 'Cristian', 'Fedre', 35876690, 0, 'sdjfhakjsdhgf', 26346193, 1),
(2, 'Pablo', 'Lopez', 45632145, 0, 'dsgdghdh', 12345678, 0),
(3, 'dsgdhgd', 'ddhsdfhdfh', 654654132, 0, 'dshdghsd', 45324354, 1);
